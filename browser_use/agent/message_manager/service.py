...
Next: I should use append_file to save this data to results.txt in the file system and proceed to the next page using the click_element_by_index action.
""".strip(),
							'next_goal': """
I should use append_file to save this data to results.txt in the file system and proceed to the next page.
""".strip(),
						},
						'action': [
							{
							...
							{'click_element_by_index': {'index': 88}},
						],
					},
