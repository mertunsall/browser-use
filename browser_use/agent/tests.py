		...
		AgentHistory(
			model_output=AgentOutput(
				current_state=AgentBrain(
					...
					reasoning_task_status='Task is incomplete as I just started.',
				),
				action=[click_action],
			),
		...
		AgentHistory(
			model_output=AgentOutput(
				current_state=AgentBrain(
					...
					reasoning_task_status='I clicked the button, but I need to extract the content. Task is incomplete.',
				),
		...
		AgentHistory(
			model_output=AgentOutput(
				current_state=AgentBrain(
					...
					reasoning_task_status='Content extraction completed, I need to finish the task.',
				),
				action=[done_action],
			),
