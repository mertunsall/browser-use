...
<Note>
  ...
  - The LLM decides how to fill the action params based on the argument names and type hints
</Note>
...
- `file_system: FileSystem` - File system model can use to read and write files
